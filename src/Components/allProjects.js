...
const projects = [
	{
		...
		techstack:
			"react, styled-components, axios, TMDB Api, react-router, react hooks",
		description:
			" Using the TMDb api, this app displays popular movies and tv shows along with the cast and general information about the selected media. You can also search for a particular movie or show. ",
	...
	// },
	{
		...
		description:
			"Landing page for a fictional cloud hosting wesbite. This project was focused on writing clean css and making the website look good on different sized screens.",
