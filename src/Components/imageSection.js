    ...
    return (
        <div className='ImageSection'>
            ...
            <div className="about-info">
                ...
                <p>Graduated from UC Berkeley with a degree in Molecular Biology, but have always had my eye on a seperate field. As I spent more and more of my free time learning about the different aspects of software, I realized I wanted a career change.
